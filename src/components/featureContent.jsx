...
function FeaturedContent() {
  ...
  const promoData = {
    ...
    description:
      "Quà tặng sinh nhật Cốc uống nước bằng gốm hình bánh dễ thương hình bánh 410ml thích hợp làm quà tặng chất lượng cao cấp",
    buttonText: "Shop Now",
    buttonLink:
    ...
    backgroundImage:
      "https://down-vn.img.susercontent.com/file/vn-11134207-7ra0g-m9q3z9oj66wyf6",
  };
